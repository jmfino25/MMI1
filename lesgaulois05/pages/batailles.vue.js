    ...
    <div class="card">
        ...
        <tbody>
            <tr v-for="bataille in listeBatailles" :key="bataille.id">
                ...
                <td>{{bataille.lesCasquesPris.length}}</td>
                <td>{{bataille.leLieu.nom}}</td>
                <td>
                    <span v-if="bataille.lesCasquesPris.length == 0" title="Supprimer la bataille" >
                        <router-link :to="{ name:'DeleteBataille', params : {id: bataille.id} }" >
                            <i class="fa fa-times fa-lg" ></i>
                        </router-link>
                    </span>    

                    <span v-if="bataille.lesCasquesPris.length > 0" title="Bataille non supprimable">
                        <a href="#">
                    ...
                    <span title="Modifier la bataille" >
                        <router-link :to="{ name:'UpdateBataille', params : {id: bataille.id} }" >
