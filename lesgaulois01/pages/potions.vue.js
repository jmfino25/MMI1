var Potions = Vue.component('Potions',{
    ...
    <div class="card">
        <div class="card-header">
            <h5> Les potions
                ...
                <a href="../pages/potion/newPotion.html" >
                    ...
                    <tr v-for="potion in listePotions" :key="potion.id">
                        ...
                        <td>
                            ...
                            <span  title="Modifier la potion">
                                <a href="../pages/potion/modifPotion.html" >
    ...
    data(){
        return{
            listePotions:[] // Liste des potions
        }
    },
    mounted(){
        // Requete Ajax via axios pour la liste des potions
        // du backEnd
        axios.get('http://localhost/jsonGaulois/listePotions.php')
